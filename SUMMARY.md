...
- Ran the handoff procedure for switching machines: `TODO.md` now contains the startup prompt, sync checklist, baseline version, app entrypoint, current open issue, and immediate next step.
