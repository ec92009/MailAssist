...
- For referral or introduction emails that connect the user with a named prospective client or collaborator, thank the introducer, greet the introduced contact by name, and invite the introduced contact to share a brief summary of the help needed or a few convenient times to connect. Do not claim availability, promise a call, or mention services beyond what the thread names.
